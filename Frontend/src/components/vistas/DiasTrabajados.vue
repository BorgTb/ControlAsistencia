      ...
      >
        <div class="mt-3">
          ...
          <div class="space-y-3">
            ...
            <div v-if="incidenteSeleccionado.horasTrabajadas">
              <label class="block text-sm font-medium text-gray-700">Horas Trabajadas</label>
              <p class="mt-1 text-sm text-gray-900">{{ incidenteSeleccionado.horasTrabajadas }}</p>
            </div>

            <!-- Horas Extras en el modal -->
            <div v-if="tieneHorasExtras(incidenteSeleccionado)" class="bg-purple-50 border border-purple-200 rounded-lg p-3">
              <label class="block text-sm font-medium text-purple-700 mb-1">Horas Extras</label>
              <p class="text-lg font-bold text-purple-900">{{ formatearMinutosAHoras(incidenteSeleccionado.minutosExtra) }}</p>
              <p class="text-xs text-purple-600 mt-1">Tiempo adicional trabajado</p>
            </div>

            <!-- Retraso en el modal -->
            <div v-if="tieneRetraso(incidenteSeleccionado)" class="bg-orange-50 border border-orange-200 rounded-lg p-3">
              <label class="block text-sm font-medium text-orange-700 mb-1">Retraso</label>
              <p class="text-lg font-bold text-orange-900">{{ formatearMinutosAHoras(incidenteSeleccionado.minutosRetraso) }}</p>
              <p class="text-xs text-orange-600 mt-1">Tiempo de atraso registrado</p>
            </div>
