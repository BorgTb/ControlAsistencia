...
import ModalNuevoTrabajador from '@/components/modals/modal-nuevo-trabajador.vue';
import ModalEnrolarTrabajador from '@/components/modals/modal-enrolar-trabajador.vue';
import ModalAmonestarTrabajador from '@/components/modals/modal-amonestar-trabajador.vue';
