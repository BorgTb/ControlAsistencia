<template>
    <div class="gestion-dispositivos max-w-7xl mx-auto p-4">
        ...
        <div v-if="modalUsuarios.show" 
             class="fixed inset-0 bg-black bg-transparent backdrop-blur-xs flex items-center justify-center z-50 p-4"
...
import { useDispositivos } from '@/composables/use-dispositivos.js';
import GestionUsuariosDispositivo from './gestion-usuarios-dispositivo.vue';
