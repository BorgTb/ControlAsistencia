...
// Nuevas rutas para gestiÃ³n completa de usuarios (solo admins)
...
// Rutas para gestiÃ³n de relaciones usuario-empresa
...
// Utilizado para determinar quÃ© usuarios ya tienen empresa asignada
router.get('/usuarios-empresas', AuthService.verifyToken, AuthService.isAdmin, UserController.getUsuariosEmpresas);

// Permite crear una nueva relaciÃ³n usuario-empresa
