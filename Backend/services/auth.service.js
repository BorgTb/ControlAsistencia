...
const loginUser = async (email, password, ip_address = null) => {
    ...
    * - El error se captura en login.controller.js y devuelve "Invalid credentials"
    ...
    if (!usuarioEmpresas || usuarioEmpresas.length === 0) {
        ...
        try {
            ...
            console.error('âŒ Error al registrar auditorÃ­a:', auditoriaError);
        }
    ...
    try {
        ...
        console.error('âŒ Error al obtener roles del usuario:', roleError);
    ...
    try {
        ...
        console.error('âŒ Error al obtener informaciÃ³n de empresa:', empresaError);
    ...
    try {
        ...
        console.error('âŒ Error al registrar auditorÃ­a de inicio de sesiÃ³n:', auditoriaError);
...
const selectCompany = async (userId, empresaId, ip_address = null) => {
    try {
        ...
        try {
            ...
            console.error('âŒ Error al obtener roles:', roleError);
            rolesSlugs = ['trabajador'];
        }
        ...
        console.error('âŒ Error en selectCompany:', error);
        throw error;
    }
};
